...
class DataValidation:
    ...
    def __init__(self,data_validation_config: config_entity.DataIngestionConfig,data_ingestion_artifact: artifact_entity.DataIngestionArtifact):
        try:
        ...
        try:
            ...
            for base_column in base_columns:
                if base_column not in current_columns:
                    logging.info(f"Column: {base_column} is missing")
